...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="section__li"
    ...
    editInput.type="text";
    editInput.className="section__input_task";
    ...
    deleteButtonImg.className="section__button-img_delete";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("section__li_edit-mode");
    ...
    listItem.classList.toggle("section__li_edit-mode");
};
